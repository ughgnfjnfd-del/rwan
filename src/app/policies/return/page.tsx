  ...
  return (
    <div className="space-y-6 text-right">
      ...
      <p className="text-xs sm:text-sm text-slate-500 leading-relaxed">
        في متجر <strong>مركز الروان</strong>، نحرص على تقديم تجربة تسوق مرضية ومضمونة. تم إعداد سياسة الاسترجاع والتبديل بوضوح لضمان حقوق الزبون وحقوق المحل وفق القوانين التجارية والضمانات المعتمدة.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-emerald-50/30 border border-emerald-100 p-5 rounded-2xl space-y-3">
          ...
          <ul className="text-xs text-slate-600 space-y-2.5 leading-relaxed">
            <li>
              <strong>الاسترجاع خلال 7 أيام</strong>: يحق للزبون استرجاع أي ملحق أو إكسسوار واسترداد قيمته بالكامل خلال 7 أيام من الشراء إذا كان بحالته الأصلية.
            </li>
            <li>
              <strong>التبديل خلال 14 يوماً</strong>: إمكانية تبديل أي منتج بمنتج آخر ذي قيمة مماثلة أو أعلى خلال 14 يوماً من تاريخ الفاتورة.
            </li>
            <li>
              <strong>العيوب المصنعية</strong>: في حال وجود عيب مصنعي واضح في الهاتف أو الملحق، يحق للزبون استبداله فوراً أو استرداد كامل المبلغ دون تحميله أي رسوم توصيل أو صيانة.
            </li>
            <li>
      ...
      <div className="bg-slate-50 border border-card-border p-5 rounded-2xl space-y-3">
        ...
        <ol className="text-xs text-slate-600 space-y-2.5 leading-relaxed list-decimal list-inside pr-1">
          <li>
            تواصل مع خدمة العملاء هاتفياً على الرقم <strong className="text-slate-800" dir="ltr">0773 165 0096</strong> أو قم بزيارة فرعنا الرئيسي في الكرادة.
          </li>
          <li>
