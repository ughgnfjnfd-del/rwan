    ...
    <div className="space-y-6 text-right">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-slate-50 border border-card-border p-5 rounded-2xl space-y-3">
          <h3 className="font-extrabold text-sm sm:text-base text-slate-800 flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-accent"></span>
            ضمان الصيانة وقطع الغيار (داخل المركز فقط)
          </h3>
          <ul className="text-xs text-slate-600 space-y-2.5 leading-relaxed">
            <li>
              <strong>ضمان داخل المركز فقط</strong>: جميع خدمات الصيانة وقطع الغيار المستبدلة (الشاشات، البطاريات، ومنافذ الشحن) مشمولة بضمان داخل المركز فقط عند الفحص والاستلام.
            </li>
            <li>
              <strong>الفحص والتجربة المباشرة</strong>: يتم فحص وتجربة القطعة المستبدلة مع الزبون والتأكد من كفاءتها الكاملة وخلوها من أي عيب داخل المركز مباشرة قبل الاستلام.
            </li>
            <li>
              <strong>حدود الضمان</strong>: ضمان الصيانة سارٍ وحصري داخل المركز فقط، ولا يشمل أي أعطال أو حوادث بعد مغادرة واستلام الجهاز من المركز.
            </li>
          </ul>
        </div>
      ...
      <div className="p-4 bg-emerald-50/30 border border-emerald-100 rounded-2xl flex gap-3 text-xs text-slate-700">
        ...
        <div>
          ...
          بالنسبة للأجهزة الجديدة المشمولة بالضمان، يرجى إحضار الهاتف مع الفاتورة الأصلية لفرعنا. أما بالنسبة لخدمات الصيانة وقطع الغيار، فالضمان سارٍ وحصري داخل المركز فقط عند الفحص والاستلام المباشر.
        </div>
      </div>
