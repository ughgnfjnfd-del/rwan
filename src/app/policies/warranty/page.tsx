    ...
    <div className="space-y-6 text-right">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-slate-50 border border-card-border p-5 rounded-2xl space-y-3">
          ...
          <ul className="text-xs text-slate-600 space-y-2.5 leading-relaxed">
            <li>
              <strong>ضمان الوكيل 12 شهراً</strong>: تشمل جميع الهواتف الجديدة ضماناً لمدة سنة كاملة ضد العيوب المصنعية والأعطال الداخلية في الهاردوير.
            </li>
            <li>
              <strong>الاستبدال الفوري</strong>: إذا تبين وجود عيب مصنعي في الهاتف خلال الـ 14 يوماً الأولى من الشراء، يتم استبداله بجهاز جديد فوراً.
            </li>
            <li>
        ...
        <div className="bg-slate-50 border border-card-border p-5 rounded-2xl space-y-3">
          ...
          <ul className="text-xs text-slate-600 space-y-2.5 leading-relaxed">
            <li>
              <strong>ضمان الشاشات والبطاريات</strong>: نوفر ضماناً حقيقياً لمدة 3 يوماً على جميع الشاشات والبطاريات وقطع الغيار التي يتم تركيبها في مركزنا.
            </li>
            <li>
              <strong>عطل القطعة المستبدلة</strong>: إذا توقفت القطعة أو ظهر فيها خلل أثناء فترة الـ 3 يوماً، يتم استبدالها بقطعة جديدة أخرى مجاناً بالكامل.
            </li>
            <li>
      ...
      <div className="bg-rose-50/20 border border-rose-100 p-5 rounded-2xl space-y-3">
        ...
        <ul className="text-xs text-slate-600 space-y-2 leading-relaxed">
          ...
          <li>
            • <strong>الصيانة الخارجية</strong>: فتح الهاتف أو إجراء أي صيانة له في مراكز غير معتمدة أو خارج متجر مركز الروان.
          </li>
          <li>
