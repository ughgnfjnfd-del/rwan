...
export default function WishlistDrawer({
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 bottom-0 right-0 z-50 w-full max-w-md bg-white shadow-2xl border-l border-card-border transition-transform duration-300 transform ${
